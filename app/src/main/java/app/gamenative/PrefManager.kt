...
object PrefManager {
    ...
    // One-shot guard for the name_sort_key / is_adult backfill (SteamService.backfillSortKeysOnce).
    // Rows synced before these columns existed have '' / 0; the backfill computes them once.
    ...
    // Resume cursor (highest processed app id) for the name_sort_key / is_adult backfill. Persisted
