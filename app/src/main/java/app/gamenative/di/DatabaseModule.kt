...
class DatabaseModule {
    ...
    fun provideDatabase(@ApplicationContext context: Context): PluviaDatabase {
        ...
        return Room.databaseBuilder(context, PluviaDatabase::class.java, DATABASE_NAME)
            .addMigrations(ROOM_MIGRATION_V7_to_V8, ROOM_MIGRATION_V20_to_V22, ROOM_MIGRATION_V21_to_V22, ROOM_MIGRATION_V23_to_V24, ROOM_MIGRATION_V24_to_V25, ROOM_MIGRATION_V25_to_V26, ROOM_MIGRATION_V26_to_V27)
